...
public final class Circle {
     ...
     * 
     * @param searchKey a <code>Integer</code> search key for searching and deleting
     *                  within an index.
     */
    ...
    /**
     * 
     * @param searchKey a integer id number for searching and deleting from an
     *                  index.
    ...
    public void draw(GraphicsContext gc) {
        ...
        gc.fillText(getKey(), point.getX(), point.getY());
    }
