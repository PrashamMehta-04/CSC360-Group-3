...
public class TreeLayoutCalculatorTest {
    ...
    public void testLayoutCalculation() {
        ...
        assertEquals(400.0 - 200.0, leftPos.getX(), 0.001); // 400 - (800/4)
        assertEquals(50.0 + 60.0, leftPos.getY(), 0.001);

        assertNotNull(rightPos);
        assertEquals(15, rightPos.getData());
        assertEquals(400.0 + 200.0, rightPos.getX(), 0.001); // 400 + (800/4)
        assertEquals(50.0 + 60.0, rightPos.getY(), 0.001);
    }
}
